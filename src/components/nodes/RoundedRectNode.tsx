...
export const RoundedRectNode = memo(function RoundedRectNode({ id, data, selected }: NodeProps<FlowNode>) {
  return (
    <NodeWrapper
      id={id}
      label={data.label}
      ...
      className="bg-fm-node-bg border-2 border-fm-node-border rounded-2xl px-4 py-2"
    />
  );
});
